...
- `docs/relatorio_atualizacao_documentacao_ia.md`
- `.github/workflows/testes-python.yml`
- `.github/pull_request_template.md`
- `.github/CODEOWNERS`
- `responsaveis_jira.exemplo.json`
- `tests/test_configuracao_repositorio.py`
...
- `.gitignore`
- `requirements.txt`
- `criar_tarefas_jira.py`
- `docs/guia_iniciantes.md`
- `docs/guias_individuais/README.md`
- os oito guias individuais;
- as oito especificações;
...
- As alterações foram publicadas no ramo histórico `codex/onboarding-ai-workflow` e no pedido de integração 1.
- Pedro e um colega já têm acesso; seis convites GitHub aguardam aceitação.
- O ramo `main` está protegido e exige uma aprovação humana.
...
4. Cada membro instala o ambiente, lê o guia e começa pela sua especificação.
