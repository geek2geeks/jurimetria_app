...
1. `constitution.md`
2. `docs/software_setup.md`
3. `docs/github_jira_workflow.md`
4. `docs/development_best_practices.md`
5. `docs/onboarding_individual/README.md`
6. o teu onboarding individual;
...
- **Branch:** linha de trabalho isolada para uma tarefa.
- **Commit:** registo de um conjunto pequeno de alterações.
- **Push:** envio dos commits para o GitHub.
- **Pull Request:** pedido para rever e juntar uma branch à `main`.
...
Segue `docs/software_setup.md`. A configuração padrão é:
...
5. Atualiza a `main`.
6. Cria uma branch com a chave real do Jira.
...
1. abre um Pull Request para `main`;
...
Consulta `docs/ai_development_workflow.md`.
...
- o ticket foi movido para `Done` depois do merge.
