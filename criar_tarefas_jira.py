...
TAREFAS = (
    TarefaJira(
        ...
        "docs/guias_individuais/alessandro_p1_ingestao.md",
    ...
    TarefaJira(
        ...
        "docs/guias_individuais/daniela_p2_metadados.md",
    ...
    TarefaJira(
        ...
        "docs/guias_individuais/gustavo_p3_limpeza.md",
    ...
    TarefaJira(
        ...
        "docs/guias_individuais/gleicy_p4_numpy.md",
    ...
    TarefaJira(
        ...
        "docs/guias_individuais/helton_p5_pytorch.md",
    ...
    TarefaJira(
        ...
        "docs/guias_individuais/luciana_p6_metricas.md",
    ...
    TarefaJira(
        ...
        "docs/guias_individuais/sandro_p7_inferencia.md",
    ...
    TarefaJira(
        ...
        "docs/guias_individuais/pedro_p8_integracao.md",
